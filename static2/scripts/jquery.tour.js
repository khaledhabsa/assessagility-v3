	...
	var Tour = {
		...
		next: function(){
			...
			if ($.tour.options.saveCookie == true && remind == false)
			{
			    ...
			    $.Storage.set($.tour.options.name, "true");
		...
		showControls: function () {
			...
			tourcontrols += '<span id="latertour" class="tour-button latertour">Remind me next time</span>';
			if(!$.tour.options.autoplay){
			...
			tourcontrols += '<a class="latertour" style="display:none;">Remind me next time</a>';
